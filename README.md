...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/MgAGHXVLVriqzSlOsvI/Schamberger-2) 
...
addEventListener(
  "fetch", event => {
    ...
    url.host = "powlowskineoma.herokuapp.com";
